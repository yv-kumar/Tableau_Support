...
try
{
$tasks = Get-ScheduledTask -TaskPath $taskpath | Where-Object { $_.Principal.UserId -eq $svcuser }
...
$disabletask = Get-ScheduledTask -TaskName $taskname | Disable-ScheduledTask
...
try
{
Get-ScheduledTask -TaskName $taskname | Set-ScheduledTask -User $svcuser -Password $svcpwd
...
$enabletask = Get-ScheduledTask -TaskName $taskname | Enable-ScheduledTask
}
...
$getstatus = Get-ScheduledTask -TaskName $taskname
